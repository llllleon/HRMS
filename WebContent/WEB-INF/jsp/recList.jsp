...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 招聘管理 <span class="c-gray en">&gt;</span> 招聘信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>

<div class="page-container">
<form id="findMy" action="${hrpath}/rec/findMyRec" method="post">
	<div  class="text-c"> 
		<input type="text" name="rectype"  id="rectype" class="input-text " value="${recMor.rectype }" style="width:120px;" placeholder="招聘类型">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="text" name="pname" id="pname" class="input-text " value="${recMor.pname }" style="width:120px;" placeholder="岗位名称">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button name="findSomeButton" type="submit" id="findSomeButton" class="btn btn-success"><i class="Hui-iconfont">&#xe665;</i>招聘信息检索</button>
	</div>
</form>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a class="btn btn-primary radius"  href="${hrpath }/rec/findSomeRec"><i class="Hui-iconfont">&#xe600;</i> 添加招聘</a></span> <span class="r">共有数据：<strong>${rownum[0]}</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			<thead>
				<tr height="30" class="text-c">
			...
			<tbody>
				...
				<c:forEach var="rec" items="${rec }">
					<tr class="text-c">
						...
						<td class="td-manage"><a style="text-decoration:none" class="ml-5" onClick="picture_del(this,${rec.recno })" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
...
//模糊查询
$('#findSomeButton').click(function(){
	//Ajax发送数据给后台 
	$.ajax({ 
		//url地址
		url :"${hrpath}/rec/findMyRec",
		//请求类型
		type : "post", 
		//返回数据的类型
		datatype : "json", 
		//传入的参数  以及  它的格式
		data : $('#findMy').serialize(),
